  ...
  'targets': [
    {
	  ...
	  'conditions': [
		  ...
		  'libraries': [
			...
			'-Wl,-rpath,<(module_root_dir)/build_deps/parquet-cpp/snappy_ep/src/snappy_ep-install/lib',
			'-L<(module_root_dir)/build_deps/parquet-cpp/brotli_ep/src/brotli_ep-install/lib',
			'-Wl,-rpath,<(module_root_dir)/build_deps/parquet-cpp/arrow_ep/src/arrow_ep-install/lib',
			'-L<(module_root_dir)/build_deps/parquet-cpp/arrow_ep/src/arrow_ep-install/lib',
			'-lsnappy',
			'-lbrotlienc',
			'-lbrotlidec',
			'-lbrotlicommon',
