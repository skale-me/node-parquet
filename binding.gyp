{
  'targets': [
    ...
    'conditions': [
      ...
      '<(module_root_dir)/build_deps/parquet-cpp/arrow_ep-prefix/src/arrow_ep-build/brotli_ep/src/brotli_ep-install/lib/libbrotlidec.a',
      '<(module_root_dir)/build_deps/parquet-cpp/arrow_ep-prefix/src/arrow_ep-build/brotli_ep/src/brotli_ep-install/lib/libbrotlienc.a',
      '<(module_root_dir)/build_deps/parquet-cpp/arrow_ep-prefix/src/arrow_ep-build/brotli_ep/src/brotli_ep-install/lib/libbrotlicommon.a',
