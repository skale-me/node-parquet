...
var readType = {
  ...
  9: function readList(buf, offset) {
    // FIXME: handle the case where n > 14
...
Reader.prototype.readCol = function (col, skip, rows) {
  ...
  var debugBuf = Buffer.alloc(1851);
  var n = fs.readSync(this._fd, debugBuf, 0, 1851, 0);
